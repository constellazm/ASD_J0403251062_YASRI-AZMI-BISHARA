...
# Latihan Dasar 1: Membaca isi seluruh file data
#=====================================================================
...
#Parsing baris menjadi data satuan dan menampilkannya dakan bentuk kolom2 data
with open("data_mahasiswa.txt", "r", encoding="utf-8") as file:
    for baris in file:
        baris = baris.strip() #menghilangkan karakter baris baru
        nim, nama, nilai = baris.split(",") #pecah menjadi data satuan dan simpan ke variabel
print ("NIM:", nim, "| Nama:", nama,"| Nilai:", nilai) #menampilkan satua data dalam bentuk kolom
