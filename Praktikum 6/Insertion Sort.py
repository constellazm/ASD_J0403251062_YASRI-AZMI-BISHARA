...
def insertionSort(data):
    for index in range(1,len(data)):
        ...
        while position > 0 and data[position-1] < currentvalue: # Masih sama seperti latihan sebelumnya, kita cukup mengubah pembanding dari lebih besar(>), menjadi lebih kecil(<)
