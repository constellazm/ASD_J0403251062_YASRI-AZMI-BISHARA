...
"""
Latihan 6: Quick Short Descending
...
def partition(data, first, last):
    ...
    while not done:
        while leftmark <= rightmark and data[leftmark] >= pivotvalue: # Selama angka di kiri lebih kecil atau sama, biarkan. Berhenti jika bertemu yang lebih besar
            leftmark = leftmark + 1

        while data[rightmark] <= pivotvalue and rightmark >= leftmark: # Selama angka di kanan lebih kecil atau sama, biarkan. Berhenti jika bertemu yang lebih besar
