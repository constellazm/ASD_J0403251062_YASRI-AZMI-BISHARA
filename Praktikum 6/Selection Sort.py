...
def selectionSort(data):
    for fillslot in range(len(data)-1,0,-1):
        ...
        for location in range(1,fillslot+1):
            if data[location] < data[positionOfMax]:  # Sama seperti latihan sebelumnya, kita cukup mengubah pembanding dari lebih besar(>), menjadi lebih kecil(<)
