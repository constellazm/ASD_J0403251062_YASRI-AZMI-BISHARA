...
def gapInsertionSort(data, start, gap):
    for i in range(start + gap, len(data), gap):
        ...
        while position >= gap and data[position - gap] < currentvalue: # Proses menggeser angka yang lebih besar ke arah kanan sejauh jarak gap agar angka yang lebih kecil bisa pindah ke posisi kiri
